 ...
 * 
 * Handles the partner logo repeater control functionality in the customizer.
 * Provides add/remove/sort functionality for partner logos with width/height controls.
 */

export default function initRepeaterControl() {
