/**
 * Customizer Preview Updates Module
 * 
 * Handles live preview updates for theme customizations including:
 * - Site title and description
 * - Footer text and copyright
 * - Partner logos with repeater functionality
 */

export default function initCustomizerPreview() {
	...
	wp.customize( 'footer_partner_1', function( value ) {
		...
		function updateExistingPartners( partners ) {
			// For safety, if any partner has empty image_id, rebuild everything
			var hasEmptyImages = partners.some( function( partner ) {
				return !partner.image_id || partner.image_id === '';
			});
