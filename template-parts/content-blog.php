<?php
/**
 * Template part for displaying blog posts in archive views matching static design
 *
 * @package selfscan
 */
?>

<article id="post-<?php the_ID(); ?>" <?php post_class('articles-blog-body__article'); ?>>
    <div class="articles-blog-body__info">
        <a href="<?php the_permalink(); ?>" class="articles-blog-body__link">
    ...
    <div class="articles-blog-body__decor">
        ...
        <?php endif; ?>
        <a href="<?php the_permalink(); ?>" class="articles-blog-body__image">
            <?php if ( has_post_thumbnail() ) : ?>
                <?php the_post_thumbnail( 'large', array( 'loading' => 'lazy', 'alt' => 'article-image' ) ); ?>
            <?php else : ?>
                <img src="<?php echo get_template_directory_uri(); ?>/img/blog-page/articles/article-image_01.jpg" loading="lazy" alt="article-image">
            <?php endif; ?>
        </a>
    </div>
</article>